...
?>
	...
	<footer id="contact-us colophon" class="site-footer" role="contentinfo">
		<div class="wrapper">
			...
			<nav id="site-navigation" class="footer-navigation" role="navigation">
				<p class="footer-nav-title"><?php echo get_theme_mod('footer_title', ''); ?></p>
				<?php wp_nav_menu(array('theme_location' => 'primary', 'menu_id' => 'footer-menu')); ?>
			</nav><!-- #site-navigation -->
			<div class="feedback-form">
				<p class="contact-form-title"><?php echo get_theme_mod('contact_form_title', ''); ?></p>
